...
namespace DVLD_Buisness
{
    ...
    public class clsLocalDrivingLicenseApplicationBL : clsApplicationsBuisnessLayer
    {
        ...
        {
            this.LocalDrivingLicenseApplicationID = clsLocalDrivingLicenseApplicationDA.AddNewLocalDrivingLicenseApplication(this.ApplicationID, this.LicenseClassID);
        ...
        {
            return clsLocalDrivingLicenseApplicationDA.UpdateLocalDrivingLicenseApplication(this.LocalDrivingLicenseApplicationID, this.ApplicationID, this.LicenseClassID);
        }
        ...
        public static clsLocalDrivingLicenseApplicationBL FindByLocalDrivingAppLicenseID(int LocalDrivingLicenseApplicationID)
        {
            ...
            bool IsFound = clsLocalDrivingLicenseApplicationDA.GetLocalDrivingLicenseApplicationInfoByID(LocalDrivingLicenseApplicationID, ref ApplicationID, ref LicenseClassID);
            ...
            if (IsFound)
            {
                ...
                return new clsLocalDrivingLicenseApplicationBL(LocalDrivingLicenseApplicationID, Application.ApplicationID,Application.ApplicantPersonID,
